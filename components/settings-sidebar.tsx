...
import { Settings2, PanelLeftOpen, PanelLeftClose, PanelRightClose } from "lucide-react"
        ...
        >
          <div className="flex h-14 items-center justify-between px-4">
            <div className="flex items-center gap-2">
              ...
              <SheetDescription className="sr-only">Configuración del temporizador</SheetDescription>
            </div>
